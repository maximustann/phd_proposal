...
% Through the research on energy-efficient server consolidation in container-based cloud, we expect to contribute to better energy efficiency 
% by designing bilevel models of container-based cloud and EC-based optimization algorithms.
...
% \bx{Two reasons motivate us to solve the initial placement of application in container-based Cloud.} 
...
% \bx{Two reasons motivate us to explore solutions for periodic placement of application in a container-based cloud}. 
% \textbf{First}, no research has considered the periodic placement of application in a container-based cloud as a bilevel multi-objective optimization problem. The multi-objective bilevel problem has two potentially conflicting objectives: reducing the number of migration and minimizing the energy consumption.
...
% \textbf{Firstly}, no research has considered dynamic placement of application in container-based cloud as a bilevel problem. Current approaches \cite{Piraghaj:2016bw} consider two placements as separate tasks. 
