...
% Most Clouds provide a set fixed types of VM (e.g IaaS) for service providers. Each type of VM represents a certain amount of resources (e.g. CPU, RAM, and Storage). This service model leads to a great waste of resources for two reasons. 
% \begin{itemize}
