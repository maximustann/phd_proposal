...
\begin{enumerate}
	...
	In this problem, time is discrete and it can be split into basic time frames such as ten seconds. A periodical operation is conducted in every $N$ time frames.
