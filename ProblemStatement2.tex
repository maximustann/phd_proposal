...
\begin{itemize}
	...
	Cloud providers establish a number of types of VM for simplify the management. The `type' means a VM contains a certain quantity of resources such as 2-cores and 1 GB RAM.  
