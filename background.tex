...
\bx{The server consolidation in data center can be applied to three placement decision scenarios \cite{Svard:2015ic, Mishra:2012kx}: Application initial placement, periodic consolidation, and dynamic placement (see Figure \ref{fig:management}).}
