...
Meng et al \cite{Meng:2010tp} proposed a correlation-based technique which matches negatively correlated VMs and place them into a single PM. However, this work only matches two applications without considering the state of current PM.
