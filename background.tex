...
Cloud computing involves three stakeholders \cite{Jennings:2015ht} (see Figure \ref{fig:stakeholders}): Cloud provider, Cloud user and End User. Each of them has their responsibility, goal, and objectives. 
\begin{itemize}
...
\begin{figure}
	\centering
	\includegraphics[width=0.4\textwidth]{pics/pyramid.png}
