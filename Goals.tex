...
We aims at providing a series of approaches to continuously optimize the a joint allocation of VMs and containers that considers three consolidation scenarios: application initial placement, periodic optimization, and dynamic placement. 
...
\begin{enumerate}
	\item How to formulate the problem so that it can be optimized by an algorithm? \\
	...
	\item How to improve the scalability of the proposed algorithm?
