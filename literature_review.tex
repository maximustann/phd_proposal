...
\bx{The chapter introduces the background of resource management in cloud computing and the related work of server consolidation strategies related to three placement decision scenarios (see Figure \ref{fig:scope}).}
