...
3                           & \begin{tabular}[c]{@{}l@{}}Develop multi-objective EC-based approaches for container-based \\ cloud in periodic placement of applications with considering various types of workload\end{tabular} & 7                 \\
...
initial placement of applications & &&&& & & & & & & &  \\
...
\cellcolor{LightCyan}  periodic placement of applications with Pareto front approach.  & & & & & & & & & & & &   \\ [1mm]
